public class Rational
{
    ...
    public boolean isSimplified() { 
        return ((simplify(this).numerator == this.numerator) && (simplify(this).denominator == this.denominator));
    }
    ...
    public Rational pow(int exponent) {
        return simplify(new Rational((int) Math.pow(this.numerator, exponent), (int) Math.pow(this.denominator, exponent)));
    }
    ...
    public Rational reciprocal() {
        return simplify(new Rational(this.denominator, this.numerator));
    }
